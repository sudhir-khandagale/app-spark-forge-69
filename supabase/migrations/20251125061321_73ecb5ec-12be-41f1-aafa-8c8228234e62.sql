-- Fix the get_vendor_analytics function to avoid nested aggregate calls
DROP FUNCTION IF EXISTS get_vendor_analytics(uuid, integer);
...
BEGIN
  ...
  -- Get aggregated metrics and top products in a single query
  RETURN QUERY
