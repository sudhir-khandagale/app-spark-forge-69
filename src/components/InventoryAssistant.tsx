  ...
  if (!isOpen) {
    return (
      <Button
        ...
        className="fixed bottom-20 right-6 h-14 w-14 rounded-full shadow-lg bg-gradient-to-r from-primary to-accent hover:scale-110 transition-transform z-50 relative"
        size="icon"
      >
